/*!
	@header		AISrFourXClass
	@abstract	AI 4x Super Resolution
	@discussion	N/A
				<br><br>
				<b>License:</b> GPL2 2023<br>
				<b>Copyright:</b> N/A
*/
...
#import "libAISR4x/libAISR4x.h"
#import "PSPlugins.h"

@interface AISrFourXClass : NSObject {
    ...
    IBOutlet NSTextField *m_textInfo;
    IBOutlet NSProgressIndicator  *m_progress;
    IBOutlet NSButton *m_btApply;
    IBOutlet NSButton *m_btCancel;
    ...
    unsigned char *m_outDataX4;

    libAISR4x *m_rvmProcess;
}
