/*!
	@header		Constants
	@abstract	Defines various constants use by PixelStyle and the XCF file
				format.
	@discussion	N/A
				<br><br>
...
typedef enum PS_EDIT_CHANNEL_TYPE{
    kEditAllChannels,
    kEditPrimaryChannels,
    kEditRedChannels,
    kEditGreenChannels,
    kEditBlueChannels,
    kEditAlphaChannel,
    kEditRedGreenChannel,
    kEditRedBlueChannel,
    kEditGreenBlueChannel
}PS_EDIT_CHANNEL_TYPE;
...
/*!
	...
	@discussion	Specifies the maximum size of an image, this restricts images to
				256 MB.
*/
#define kMaxImageSize 36000 //8192   //wzq
