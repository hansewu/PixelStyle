...
@interface PSMargins : NSObject<NSTextFieldDelegate> {
    ...
    IBOutlet NSTextField *m_labelTop;
    IBOutlet NSTextField *m_labelBottom;
    IBOutlet NSTextField *m_labelLeft;
    IBOutlet NSTextField *m_labelRight;
