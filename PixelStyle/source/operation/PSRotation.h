...
@interface PSRotation : NSObject
{
	...
	IBOutlet id m_idRotateValue;

    IBOutlet NSTextField    *m_labelRotate;
    IBOutlet NSTextField    *m_labelDegrees;
    
    IBOutlet NSButton       *m_btnCancel;
    IBOutlet NSButton       *m_btnRotate;
    
	// A list of rotation undo records required for undoing
	RotationUndoRecord *m_pRURUndoRecords;
