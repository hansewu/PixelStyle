...
@interface PSContent : NSObject {
	...
	int m_nHeight, m_nWidth, m_nType;
	...
	NSMutableArray *m_arrLayers;
	
	// These are layers that are no longer in the document but are kept for undo m_idOperations
	NSMutableArray *m_arrDeletedLayers;	
	NSMutableArray *m_maLayersToUndo;
	NSMutableArray *m_maLayersToRedo;
	NSMutableArray *m_maOrderings;
	
	// Stores index of layer that is active
	int m_nActiveLayerIndex;
	...
	IndiciesKeeper m_sKeeper;
	
	// All the parasites
	ParasiteData *m_psParasites;
	int m_nParasitesCount;
	
	// Save as a CMYK TIFF file
	BOOL m_bCMYKSave;
	
	// The EXIF data associated with this image
	NSDictionary *m_dicExifData;
    
    WDDrawingController *m_drawingController;//_ = [[WDDrawingController alloc] init];
    WDDrawing *m_drawing;
}
...
/*!
	@method		versionMajor
	@discussion	Returns the content versionMajor.
	@result		Returns an integer representing the content versionMajor (see Constants
 documentation).
 */
- (int)versionMajor;
...
/*!
	@method		versionMinor
	@discussion	Returns the content versionMinor.
	@result		Returns an integer representing the content versionMinor.
 */
- (int)versionMinor;
/*!
	@method		type
...
/*!
	...
	@discussion	Returns the parasistes of the document. Parasites are arbitrary
				pieces of data that are saved by the GIMP and PixelStyle in XCF
				documents.
...
/*!
	...
	@result		An instance of PSLayer corresponding to the specified index.
*/
- (id)layer:(int)index;
...
*/
- (int)layerCount;
- (int)layerIndex:(id)layer; //add by lcz

/*!
	@method		activeLayer
	@discussion	Returns the currently active layer.
	@result		An instance of PSLayer representing the active layer.
*/
- (id)activeLayer;
...
- (void)makePasteboardFloat:(NSPasteboard *)pDragBoard center:(NSPoint)point;
