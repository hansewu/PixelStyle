...
@interface PSAbstractPanel ()

@end

@implementation PSAbstractPanel
...
- (void)awakeFromNib
{
    ...
    [m_winWindow setPanelStyle:kVerticalPanelStyle];
    m_winParent = NULL;
    // Implement this method to handle any initialization after your window controller's window has been loaded from its nib file.
    
    
//    [m_winWindow setAlphaValue:0.8];
}
...
- (void)showPanelFrom:(NSPoint)p onWindow: (NSWindow *)parent
{
    ...
    [(InfoPanel *)m_winWindow makeKeyWindow];
}
