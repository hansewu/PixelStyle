...
- (void)mouseDown:(NSEvent *)event
{
	...
	if (elemNo < [[m_idMaster brushes] count]) {
		[m_idMaster setActiveBrushIndex:elemNo];
...
{
	NSArray *brushes = [m_idMaster brushes];
	int brushCount =  [brushes count];
	int activeBrushIndex = [m_idMaster activeBrushIndex];
	int i, j, elemNo;
	NSImage *thumbnail;
