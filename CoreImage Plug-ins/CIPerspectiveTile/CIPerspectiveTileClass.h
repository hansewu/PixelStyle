...
@interface CIPerspectiveTileClass : NSObject {
    ...
    IBOutlet id panel;
    IBOutlet id m_tlpositionXSlider;
    IBOutlet id m_tlpositionYSlider;
    IBOutlet id m_trpositionXSlider;
    IBOutlet id m_trpositionYSlider;
    IBOutlet id m_blpositionXSlider;
    IBOutlet id m_blpositionYSlider;
    IBOutlet id m_brpositionXSlider;
    IBOutlet id m_brpositionYSlider;
    
    
    IBOutlet id m_tlpositionXLabel;
    IBOutlet id m_tlpositionYLabel;
    IBOutlet id m_trpositionXLabel;
    IBOutlet id m_trpositionYLabel;
    IBOutlet id m_blpositionXLabel;
    IBOutlet id m_blpositionYLabel;
    IBOutlet id m_brpositionXLabel;
    IBOutlet id m_brpositionYLabel;
