...
- (void)execute
{
    ...
    resdata = [self edges:pluginData withBitmap:newdata];
...
- (unsigned char *)edges:(PluginData *)pluginData withBitmap:(unsigned char *)data
{
    ...
    NSColor *foreNSColor = [m_colorForeground color]; //foreNSColor
    NSColor *backNSColor = [m_colorBackground color];
    if ([pluginData spp] == 2) {
        foreNSColor = [foreNSColor colorUsingColorSpaceName:NSCalibratedWhiteColorSpace];
        backNSColor = [backNSColor colorUsingColorSpaceName:NSCalibratedWhiteColorSpace];
    }else{
        foreNSColor = [foreNSColor colorUsingColorSpaceName:NSCalibratedRGBColorSpace];
        backNSColor = [backNSColor colorUsingColorSpaceName:NSCalibratedRGBColorSpace];
    }
	
	// Check if image is opaque
	opaque = ![pluginData hasAlpha];
    
	if (opaque && [pluginData spp] == 4) backColor = [CIColor colorWithRed:[backNSColor redComponent] green:[backNSColor greenComponent] blue:[backNSColor blueComponent]];
	else if (opaque) backColor = [CIColor colorWithRed:[backNSColor whiteComponent] green:[backNSColor whiteComponent] blue:[backNSColor whiteComponent]];
	
	// Get foreground color
	if ([pluginData spp] == 4) foreColor = [CIColor colorWithRed:[foreNSColor redComponent] green:[foreNSColor greenComponent] blue:[foreNSColor blueComponent] alpha:[foreNSColor alphaComponent]];
	else foreColor = [CIColor colorWithRed:[foreNSColor whiteComponent] green:[foreNSColor whiteComponent] blue:[foreNSColor whiteComponent] alpha:[foreNSColor alphaComponent]];
