...
@interface CIAffineTileClass : NSObject {
    ...
    //iboutlets
    IBOutlet id panel;
    IBOutlet id m_positionXSlider; //translate
    IBOutlet id m_positionYSlider;
    IBOutlet id m_scaleSlider;
    IBOutlet id m_angleSlider;
    
    IBOutlet id m_positionXLabel; //translate
    IBOutlet id m_positionYLabel;
    IBOutlet id m_scaleLabel;
    IBOutlet id m_angleLabel;
