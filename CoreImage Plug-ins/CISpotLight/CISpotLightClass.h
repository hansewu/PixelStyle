...
@interface CISpotLightClass : NSObject {
    ...
    IBOutlet id m_positionXSlider0;
    IBOutlet id m_positionYSlider0;
    IBOutlet id m_positionXSlider1;
    IBOutlet id m_positionYSlider1;

    IBOutlet id m_positionXLabel0; //center
    IBOutlet id m_positionYLabel0;
    IBOutlet id m_positionXLabel1; //center
    IBOutlet id m_positionYLabel1;
}
